...
/* General feel */
body { color: black; background: #c5baab url(${h.static_uri('spline.instance', 'images/layout/background.png')}) repeat; }
...
#header { position: relative; height: 8em; color: white; background: #6998df url(${h.static_uri('spline.instance', 'images/layout/header-background.png')}) center no-repeat; }
...
#header #pokedex-lookup { position: absolute; right: 1em; bottom: 1em; padding-top: 160px; min-width: 194px; /* make sure pokedex image fits */ padding-right: 1em; padding-bottom: 1em; background: url(${h.static_uri('spline.instance', 'images/layout/pokedex.png')}) right bottom no-repeat; }
